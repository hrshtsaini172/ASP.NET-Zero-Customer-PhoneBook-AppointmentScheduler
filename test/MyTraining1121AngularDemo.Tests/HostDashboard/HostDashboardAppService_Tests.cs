...
using MyTraining1121AngularDemo.MultiTenancy.HostDashboard;
...
namespace MyTraining1121AngularDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(MyTraining1121AngularDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
