...
namespace MyTraining1121AngularDemo.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<MyTraining1121AngularDemoDbContext>>()
            ...
            new MyTraining1121AngularDemoDbContext(builder.Options).Database.EnsureCreated();
        }
