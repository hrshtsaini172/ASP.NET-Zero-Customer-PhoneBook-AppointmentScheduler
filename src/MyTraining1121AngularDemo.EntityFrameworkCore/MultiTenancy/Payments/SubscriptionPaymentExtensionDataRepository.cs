...
{
    public class SubscriptionPaymentExtensionDataRepository : MyTraining1121AngularDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<MyTraining1121AngularDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
