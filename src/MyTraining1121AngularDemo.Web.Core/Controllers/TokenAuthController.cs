...
using MyTraining1121AngularDemo.Web.Models.TokenAuth;
using MyTraining1121AngularDemo.Authorization.Impersonation;
...
using MyTraining1121AngularDemo.Web.Authentication.External;
...
namespace MyTraining1121AngularDemo.Web.Controllers
{
    ...
    public class TokenAuthController : MyTraining1121AngularDemoControllerBase
    {
