...
{
    public class MyTraining1121AngularDemoAsyncJwtSecurityTokenHandler : IAsyncSecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public MyTraining1121AngularDemoAsyncJwtSecurityTokenHandler()
        {
