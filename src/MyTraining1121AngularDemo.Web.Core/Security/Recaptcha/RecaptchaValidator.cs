...
namespace MyTraining1121AngularDemo.Web.Security.Recaptcha
{
    public class RecaptchaValidator : MyTraining1121AngularDemoServiceBase, IRecaptchaValidator, ITransientDependency
    {
