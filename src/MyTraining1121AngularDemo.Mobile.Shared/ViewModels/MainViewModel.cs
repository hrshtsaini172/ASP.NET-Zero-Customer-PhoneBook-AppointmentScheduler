...
using MyTraining1121AngularDemo.Commands;
...
using MyTraining1121AngularDemo.Controls;
using MyTraining1121AngularDemo.Dto;
using MyTraining1121AngularDemo.Extensions;
using MyTraining1121AngularDemo.Localization;
using MyTraining1121AngularDemo.UI;
using MyTraining1121AngularDemo.UI.Assets;
using MyTraining1121AngularDemo.Views;
using DependencyResolver = MyTraining1121AngularDemo.Core.Dependency.DependencyResolver;
...
namespace MyTraining1121AngularDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "MyTraining1121AngularDemo";
