...
using MyTraining1121AngularDemo.Authorization.Users.Password;
...
using MyTraining1121AngularDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace MyTraining1121AngularDemo.Web.Startup
{
    ...
    public class MyTraining1121AngularDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MyTraining1121AngularDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyTraining1121AngularDemoWebHostModule).GetAssembly());
        }
