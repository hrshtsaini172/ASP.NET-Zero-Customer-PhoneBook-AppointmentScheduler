...
using MyTraining1121AngularDemo.Localization.Resources;
using MyTraining1121AngularDemo.ViewModels.Base;
using Plugin.Connectivity;
using Process = Android.OS.Process;

namespace MyTraining1121AngularDemo.Activities
{
    ...
    public class SplashActivity : AppCompatActivity
    {
        ...
        {
            base.OnResume();
            ApplicationBootstrapper.InitializeIfNeeds<MyTraining1121AngularDemoXamarinAndroidModule>();
