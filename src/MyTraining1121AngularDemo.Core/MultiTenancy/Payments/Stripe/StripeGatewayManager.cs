...
{
    public class StripeGatewayManager : MyTraining1121AngularDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "MyTraining1121AngularDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + MyTraining1121AngularDemoConsts.Currency;
        }
