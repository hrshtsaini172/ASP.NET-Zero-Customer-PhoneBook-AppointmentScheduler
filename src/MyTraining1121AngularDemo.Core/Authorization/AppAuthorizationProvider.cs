...
namespace MyTraining1121AngularDemo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            customers.CreateChildPermission(AppPermissions.Pages_Tenant_Customers_EditCustomer, L("EditCustomer"), multiTenancySides: MultiTenancySides.Tenant);
            customers.CreateChildPermission(AppPermissions.Pages_Tenant_Customers_ViewCustomerUsers, L("ViewCustomerUsers"), multiTenancySides: MultiTenancySides.Tenant);
            customers.CreateChildPermission(AppPermissions.Pages_Tenant_Customers_DeleteCustomerUsers, L("DeleteCustomerUsers"), multiTenancySides: MultiTenancySides.Tenant);
            customers.CreateChildPermission(AppPermissions.Pages_Tenant_Customers_AddCustomerUsers, L("AddCustomerUsers"), multiTenancySides: MultiTenancySides.Tenant);

            var appointments = pages.CreateChildPermission(AppPermissions.Pages_Tenant_Appointments, L("Appointments"), multiTenancySides: MultiTenancySides.Tenant);
            appointments.CreateChildPermission(AppPermissions.Pages_Tenant_Appointments_CreateAppointment, L("CreateNewAppointment"), multiTenancySides: MultiTenancySides.Tenant);
            appointments.CreateChildPermission(AppPermissions.Pages_Tenant_Appointments_DeleteAppointment, L("DeleteAppointment"), multiTenancySides: MultiTenancySides.Tenant);
            appointments.CreateChildPermission(AppPermissions.Pages_Tenant_Appointments_EditAppointment, L("EditAppointment"), multiTenancySides: MultiTenancySides.Tenant);
            appointments.CreateChildPermission(AppPermissions.Pages_Tenant_Appointments_ViewUpcomingAppointments, L("ViewUpcomingAppointments"), multiTenancySides: MultiTenancySides.Tenant);
            appointments.CreateChildPermission(AppPermissions.Pages_Tenant_Appointments_ViewCancelledAppointments, L("ViewCancelledAppointments"), multiTenancySides: MultiTenancySides.Tenant);
