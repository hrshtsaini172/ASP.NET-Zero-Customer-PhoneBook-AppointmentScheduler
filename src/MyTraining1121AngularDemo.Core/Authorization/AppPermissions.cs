namespace MyTraining1121AngularDemo.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_Tenant_Customers_AddCustomerUsers = "Pages.Tenant.Customers.AddCustomerUsers";
        public const string Pages_Tenant_Customers_ViewCustomerUsers = "Pages.Tenant.Customers.ViewCustomerUsers";
        public const string Pages_Tenant_Customers_DeleteCustomerUsers = "Pages.Tenant.Customers.DeleteCustomerUsers";

        public const string Pages_Tenant_Appointments = "Pages.Tenant.Appointments";
        public const string Pages_Tenant_Appointments_CreateAppointment = "Pages.Tenant.Appointments.CreateAppointment";
        public const string Pages_Tenant_Appointments_DeleteAppointment = "Pages.Tenant.Appointments.DeleteAppointment";
        public const string Pages_Tenant_Appointments_EditAppointment = "Pages.Tenant.Appointments.EditAppointment";
        public const string Pages_Tenant_Appointments_ViewUpcomingAppointments = "Pages.Tenant.Appointments.ViewUpcomingAppointments";
        public const string Pages_Tenant_Appointments_ViewCancelledAppointments = "Pages.Tenant.Appointments.ViewCancelledAppointments";
