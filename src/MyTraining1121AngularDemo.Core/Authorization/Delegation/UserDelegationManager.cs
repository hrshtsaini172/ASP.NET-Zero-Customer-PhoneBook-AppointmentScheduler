...
namespace MyTraining1121AngularDemo.Authorization.Delegation
{
    public class UserDelegationManager : MyTraining1121AngularDemoServiceBase, IUserDelegationManager
    {
