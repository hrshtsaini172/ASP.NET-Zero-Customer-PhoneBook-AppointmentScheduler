...
using MyTraining1121AngularDemo.Authorization.Ldap;
...
using MyTraining1121AngularDemo.DashboardCustomization.Definitions;
using MyTraining1121AngularDemo.Debugging;
using MyTraining1121AngularDemo.DynamicEntityProperties;
using MyTraining1121AngularDemo.Features;
...
using MyTraining1121AngularDemo.WebHooks;
using Newtonsoft.Json;

namespace MyTraining1121AngularDemo
{
    [DependsOn(
        typeof(MyTraining1121AngularDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class MyTraining1121AngularDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            MyTraining1121AngularDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = MyTraining1121AngularDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, MyTraining1121AngularDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<MyTraining1121AngularDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyTraining1121AngularDemoCoreModule).GetAssembly());
        }
