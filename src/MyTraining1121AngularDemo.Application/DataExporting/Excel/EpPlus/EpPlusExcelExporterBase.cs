...
namespace MyTraining1121AngularDemo.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : MyTraining1121AngularDemoServiceBase, ITransientDependency
    {
