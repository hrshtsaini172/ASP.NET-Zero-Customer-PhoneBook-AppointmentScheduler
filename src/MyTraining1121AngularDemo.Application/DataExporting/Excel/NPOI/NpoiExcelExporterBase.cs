...
namespace MyTraining1121AngularDemo.DataExporting.Excel.NPOI
{
    public abstract class NpoiExcelExporterBase : MyTraining1121AngularDemoServiceBase, ITransientDependency
    {
