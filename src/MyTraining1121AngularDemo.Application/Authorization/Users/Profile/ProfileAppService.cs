...
using MyTraining1121AngularDemo.Authentication.TwoFactor.Google;
using MyTraining1121AngularDemo.Authorization.Users.Dto;
using MyTraining1121AngularDemo.Authorization.Users.Profile.Cache;
...
using MyTraining1121AngularDemo.Gdpr;
using MyTraining1121AngularDemo.Net.Sms;
using MyTraining1121AngularDemo.Security;
using MyTraining1121AngularDemo.Storage;
using MyTraining1121AngularDemo.Timing;
...
{
    [AbpAuthorize]
    public class ProfileAppService : MyTraining1121AngularDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("MyTraining1121AngularDemo",
