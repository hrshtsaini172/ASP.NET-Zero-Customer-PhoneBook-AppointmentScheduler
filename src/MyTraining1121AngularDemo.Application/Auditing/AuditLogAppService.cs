...
using MyTraining1121AngularDemo.Auditing.Exporting;
...
using EntityHistoryHelper = MyTraining1121AngularDemo.EntityHistory.EntityHistoryHelper;

namespace MyTraining1121AngularDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : MyTraining1121AngularDemoAppServiceBase, IAuditLogAppService
    {
