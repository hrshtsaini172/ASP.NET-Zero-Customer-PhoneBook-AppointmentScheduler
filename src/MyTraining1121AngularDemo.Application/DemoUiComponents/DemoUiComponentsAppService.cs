...
using MyTraining1121AngularDemo.DemoUiComponents.Dto;

namespace MyTraining1121AngularDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : MyTraining1121AngularDemoAppServiceBase, IDemoUiComponentsAppService
    {
