...
{
    public class SessionAppService : MyTraining1121AngularDemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = MyTraining1121AngularDemoConsts.Currency,
                        CurrencySign = MyTraining1121AngularDemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = MyTraining1121AngularDemoConsts.AllowTenantsToChangeEmailSettings,
