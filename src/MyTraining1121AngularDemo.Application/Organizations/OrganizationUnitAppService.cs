...
namespace MyTraining1121AngularDemo.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : MyTraining1121AngularDemoAppServiceBase, IOrganizationUnitAppService
    {
