...
using MyTraining1121AngularDemo.MultiTenancy.Payments.Paypal;
using MyTraining1121AngularDemo.MultiTenancy.Payments.PayPal;
...
{
    public class PayPalPaymentAppService : MyTraining1121AngularDemoAppServiceBase, IPayPalPaymentAppService
    {
