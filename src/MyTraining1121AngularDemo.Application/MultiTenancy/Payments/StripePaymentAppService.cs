...
using MyTraining1121AngularDemo.MultiTenancy.Payments.Stripe;
...
{
    public class StripePaymentAppService : MyTraining1121AngularDemoAppServiceBase, IStripePaymentAppService
    {
