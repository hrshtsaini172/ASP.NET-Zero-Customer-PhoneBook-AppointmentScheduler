...
namespace MyTraining1121AngularDemo.Core.Base
{
    public abstract class MyTraining1121AngularDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected MyTraining1121AngularDemoQueryBase(string fieldName,
