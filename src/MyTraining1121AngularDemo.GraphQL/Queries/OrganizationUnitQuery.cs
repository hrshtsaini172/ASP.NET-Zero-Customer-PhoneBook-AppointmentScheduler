...
using MyTraining1121AngularDemo.Core.Base;
using MyTraining1121AngularDemo.Core.Extensions;
using MyTraining1121AngularDemo.Dto;
using MyTraining1121AngularDemo.Types;

namespace MyTraining1121AngularDemo.Queries
{
    public class OrganizationUnitQuery : MyTraining1121AngularDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
