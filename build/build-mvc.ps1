...
$webMvcFolder = Join-Path $slnFolder "src/MyTraining1121AngularDemo.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/MyTraining1121AngularDemo.Web.Public"
...
dotnet restore MyTraining1121AngularDemo.Web.sln
